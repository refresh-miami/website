...
$bp_ajax_qs = bp_ajax_querystring( 'members' );
// $bp_ajax_qs = 'type=active&action=active&page=1&include=301,302';
$bps_filter_members = apply_filters('rm_filter_members', $bp_ajax_qs, 'members');

// echo 'bps_filter_members (filtered): ' . $bps_filter_members . '<br>';
...
<?php // print_r( bp_ajax_querystring( 'members' ) ); ?>

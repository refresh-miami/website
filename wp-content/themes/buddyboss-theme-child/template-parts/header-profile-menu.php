...
?>
    ...
    <?php /* <li id="wp-admin-bar-my-account-xprofile" class="menupop parent">
        <a class="ab-item" aria-haspopup="true" href="<?php echo home_url('dashboard'); ?>">
            <span class="wp-admin-bar-arrow" aria-hidden="true"></span><?php _e( 'Dashboard', 'buddyboss-theme' ); ?>
        </a>
    </li> */ ?>
...
<?php
		...
		<li id="wp-admin-bar-my-account-settings" class="menupop parent">
			...
			<div class="ab-sub-wrapper wrapper">
				<ul id="wp-admin-bar-my-account-settings-default" class="ab-submenu">
					...
					<li id="wp-admin-bar-my-account-settings-subscriptions">
						<a class="ab-item" href="<?php echo trailingslashit( $settings_link . 'account/' ); ?>">
							<?php _e( 'Memberships', 'buddyboss-theme' ); ?>
						</a>
					</li>
					<li id="wp-admin-bar-my-account-settings-subscriptions">
						<a class="ab-item" href="<?php echo trailingslashit( $settings_link . 'blocked-users/' ); ?>">
							<?php _e( 'Blocked', 'buddyboss-theme' ); ?>
						</a>
					</li>
	...
	if ( true === $groups_flag && bp_is_active( 'groups' ) ) {
		// Setup the logged in user variables.
	...
	if ( bp_is_active( 'groups' ) ) {
		// Setup the logged in user variables.
		$meetups_link = trailingslashit( bp_loggedin_user_domain() . 'meetups' );

		// Pending group invites.
		$count   = rm_groups_total_meetups_for_user( bp_loggedin_user_id() );
		$title   = __( 'Meetups', 'buddyboss-theme' );
		$pending = __( 'No Pending Invites', 'buddyboss-theme' );

		if ( ! empty( $count ) ) {
			$title = sprintf(
				__( 'Meetups %s', 'buddyboss-theme' ),
				'<span class="count">' . bp_core_number_format( $count ) . '</span>'
			);
		}
		...
		?>
		<li id="wp-admin-bar-my-account-groups" class="menupop parent">
			<a class="ab-item" aria-haspopup="true" href="<?php echo esc_url( $meetups_link ); ?>">
				<span class="wp-admin-bar-arrow" aria-hidden="true"></span><?php echo $title; ?>
			</a>
		</li>
		<?php
	...
	if ( bp_is_active( 'forums' ) ) {
		...
		<li id="wp-admin-bar-my-account-forums" class="menupop parent">
			<a class="ab-item" aria-haspopup="true" href="<?php echo esc_url( $forums_link ); ?>">
				<span class="wp-admin-bar-arrow" aria-hidden="true"></span><?php _e( 'Discussions', 'buddyboss-theme' ); ?>
			</a>
			<div class="ab-sub-wrapper wrapper">
		...
		<li id="wp-admin-bar-my-account-invites" class="menupop parent">
			...
			<div class="ab-sub-wrapper wrapper">
				<ul id="wp-admin-bar-my-account-invites-default" class="ab-submenu">
					<?php /* <li id="wp-admin-bar-my-account-invites-invites">
					...
					<li id="wp-admin-bar-my-account-invites-invites">
						<a class="ab-item" href="<?php echo esc_url( trailingslashit( $invites_link . 'invite-new-members' ) ); ?>"><?php _e( 'Send Invites', 'buddyboss-theme' ); ?></a>
					</li>
					<li id="wp-admin-bar-my-account-invites-sent">
						<a class="ab-item" href="<?php echo esc_url( trailingslashit( $invites_link . 'my-sent-invites' ) ); ?>"><?php _e( 'Sent Invites', 'buddyboss-theme' ); ?></a>
					</li>
					<?php /* <li id="wp-admin-bar-my-account-invite-codes">
						<a class="ab-item" href="<?php echo esc_url( trailingslashit( $invites_link . 'invite-codes' ) ); ?>"><?php _e( 'Invite Codes', 'buddyboss-theme' ); ?></a>
					</li> */ ?>
				</ul>
			</div>
		</li>

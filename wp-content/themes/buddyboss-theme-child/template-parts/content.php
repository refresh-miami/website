	...
	<div class="entry-content-wrap">
		...
		<?php if ( is_singular() && ! is_related_posts() ) { ?>
			...
			<?php
				...
				$content_output = $post->post_content;
				// $content_output = nl2br( $content_output );
				$content_output = nl2br( $content_output );
				$content_output = apply_filters('the_content', $content_output);
                $content_output = str_replace( '<br />', '</p><p>', $content_output);
				//$content_output = wpautop( $content_output, false );
				echo $content_output;
				// echo $content_output;

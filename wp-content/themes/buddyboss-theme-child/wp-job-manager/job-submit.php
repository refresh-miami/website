	...
	<?php if ( job_manager_user_can_post_job() || job_manager_user_can_edit_job( $job_id ) ) : ?>
		...
		<?php if ( $company_fields ) : ?>
            ...
            <?php
                ...
                $businesses = rm_get_user_businesses( bp_loggedin_user_id() );

                if ( !empty( $businesses ) ) {

            ?>

            <fieldset class="fieldset-company_type fieldset-type-radio">
					<label for="company_name">Company Type</label>
					<div class="field required-field">
                        <select class="input-select" name="company_type" id="company_type">
                            <option value="registered">This Job Is For A Company I'm Registered With</option>
                            <option value="not-registered">This Job Is For A Company I'm Not Registered With</option>
                        </select>
					</div>
			</fieldset>

            <fieldset class="fieldset-registered_company fieldset-type-select">
					<label for="company_name">Select Registered Company</label>
					<div class="field required-field">
                        <select class="input-select" name="registered_company" id="registered_company">
                            <?php
